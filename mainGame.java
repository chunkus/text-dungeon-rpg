...
public static void dungeon1()
	{
		...
		player1=setX(player1, 1);
		player1=setY(player1, 1);
...
public static dungeon[][] createRooms(dungeon[][] n)
	{
		n[1][1] = new dungeon();
		n[1][1] = setExit(n[1][1], "There is a north, south, east and west exit");
		n[1][1] = setDescription(n[1][1], "central room");
		n[1][1] = setItems(n[1][1], "nothing");
		n[1][1] = setMonster(n[1][1], false);

		n[0][1] = new dungeon();
		n[0][1] = setExit(n[0][1], "There is a north, south and east exit");
		n[0][1] = setDescription(n[0][1], "a bright green room, very calming");
		n[0][1] = setItems(n[0][1], "a leaf");
		n[0][1] = setMonster(n[0][1], false);

		n[1][2] = new dungeon();
		n[1][2] = setExit(n[1][2], "There is a west, east and south exit");
		n[1][2] = setDescription(n[1][2], "a dark red room");
		n[1][2] = setItems(n[1][2], "a red spatula");
		n[1][2] = setMonster(n[1][2], true);
		
		n[2][1] = new dungeon();
		n[2][1] = setExit(n[2][1], "Ther is a north, west and south exit");
		n[2][1] = setDescription(n[2][1], " a room full of vines and dead corpses");
		n[2][1] = setItems(n[2][1], "a pebble");
		n[2][1] = setMonster(n[2][1], true);

		n[1][0] = new dungeon();
		n[1][0] = setExit(n[1][0], "There is a north, west and east exit");
		n[1][0] = setDescription(n[1][0], "an emplty dull room");
		n[1][0] = setItems(n[1][0], "spider silk");
		n[1][0] = setMonster(n[1][0], true);
		
		n[0][2] = new dungeon();
		n[0][2] = setExit(n[0][2], "There is an east and south exit");
		n[0][2] = setDescription(n[0][2], "a large brown room");
		n[0][2] = setItems(n[0][2], "a potato");
		n[0][2] = setMonster(n[0][2], true);
		
		n[2][2] = new dungeon();
		n[2][2] = setExit(n[2][2], "There is an west and south exit");
		n[2][2] = setDescription(n[2][2], "a tiny purple room");
		n[2][2] = setItems(n[2][2], "cheese");
		n[2][2] = setMonster(n[2][2], true);
		
		n[0][0] = new dungeon();
		n[0][0] = setExit(n[0][0], "There is an east and north exit");
		n[0][0] = setDescription(n[0][0], "a small modern looking room");
		n[0][0] = setItems(n[0][0], "a sophisticated vase");
		n[0][0] = setMonster(n[0][0], false);
		
		n[2][0] = new dungeon();
		n[2][0] = setExit(n[2][0], "There is an west and north exit");
		n[2][0] = setExit(n[2][0], "There is an west and north exit");
		n[2][0] = setItems(n[2][0], "a plain looking sword");
		n[2][0] = setMonster(n[2][0], true);
